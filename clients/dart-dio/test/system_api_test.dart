...
void main() {
  ...
  group(SystemApi, () {
    ...
    //
    //Future<JsonObject> systemChangePasswordSystemChangePasswordPost(String type, String oldPassword, String newPassword) async
    ...
    //
    //Future<JsonObject> systemRebootSystemRebootPost() async
    ...
    //
    //Future<JsonObject> systemShutdownSystemShutdownPost() async
