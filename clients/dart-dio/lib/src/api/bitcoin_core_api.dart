...
class BitcoinCoreApi {
  ...
  const BitcoinCoreApi(this._dio, this._serializers);
  ...
  Future<Response<JsonObject>> bitcoinBlockSubBitcoinBlockSubGet({ 
    int? verbosity = 1,
    ...
    final _path = r'/bitcoin/block-sub';
    ...
    final _queryParameters = <String, dynamic>{
      if (verbosity != null) r'verbosity': encodeQueryParameter(_serializers, verbosity, const FullType(int)),
    };
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BtcInfo] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BtcInfo>> bitcoinBtcInfoBitcoinBtcInfoGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/bitcoin/btc-info';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BtcInfo _responseData;

    try {
      const _responseType = FullType(BtcInfo);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as BtcInfo;
  ...
  ///
  /// Parameters:
  /// * [targetConf] - Confirmation target in blocks.
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<int>> bitcoinEstimateFeeBitcoinEstimateFeeGet({ 
    int? targetConf = 6,
    ...
    final _path = r'/bitcoin/estimate-fee';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (targetConf != null) r'target_conf': encodeQueryParameter(_serializers, targetConf, const FullType(int)),
      if (mode != null) r'mode': encodeQueryParameter(_serializers, mode, const FullType(FeeEstimationMode)),
    };
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<JsonObject>> bitcoinGetBlockCountBitcoinGetBlockCountGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/bitcoin/get-block-count';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BlockchainInfo] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BlockchainInfo>> bitcoinGetBlockchainInfoBitcoinGetBlockchainInfoGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/bitcoin/get-blockchain-info';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BlockchainInfo _responseData;

    try {
      const _responseType = FullType(BlockchainInfo);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as BlockchainInfo;
    ...
    return Response<BlockchainInfo>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [NetworkInfo] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<NetworkInfo>> bitcoinGetNetworkInfoBitcoinGetNetworkInfoGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/bitcoin/get-network-info';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    NetworkInfo _responseData;

    try {
      const _responseType = FullType(NetworkInfo);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as NetworkInfo;
