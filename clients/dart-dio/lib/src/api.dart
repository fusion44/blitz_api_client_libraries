...
import 'package:openapi/src/api/bitcoin_core_api.dart';
import 'package:openapi/src/api/lightning_api.dart';
import 'package:openapi/src/api/setup_api.dart';
...
class Openapi {
  ...
  /// Get BitcoinCoreApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  BitcoinCoreApi getBitcoinCoreApi() {
    return BitcoinCoreApi(dio, serializers);
  }

  /// Get LightningApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  LightningApi getLightningApi() {
    return LightningApi(dio, serializers);
  }
