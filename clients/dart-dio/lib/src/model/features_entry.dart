...
/// * [key] 
/// * [value] 
abstract class FeaturesEntry implements Built<FeaturesEntry, FeaturesEntryBuilder> {
    ...
    factory FeaturesEntry([void updates(FeaturesEntryBuilder b)]) = _$FeaturesEntry;

    @BuiltValueSerializer(custom: true)
    static Serializer<FeaturesEntry> get serializer => _$FeaturesEntrySerializer();
}
...
class _$FeaturesEntrySerializer implements StructuredSerializer<FeaturesEntry> {
    ...
    @override
    FeaturesEntry deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
