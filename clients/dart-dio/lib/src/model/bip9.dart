...
abstract class Bip9 implements Built<Bip9, Bip9Builder> {
    ...
    static void _defaults(Bip9Builder b) => b;

    factory Bip9([void updates(Bip9Builder b)]) = _$Bip9;

    @BuiltValueSerializer(custom: true)
    static Serializer<Bip9> get serializer => _$Bip9Serializer();
}

class _$Bip9Serializer implements StructuredSerializer<Bip9> {
    @override
    final Iterable<Type> types = const [Bip9, _$Bip9];

    @override
    final String wireName = r'Bip9';

    @override
    Iterable<Object?> serialize(Serializers serializers, Bip9 object,
    ...
    @override
    Bip9 deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = Bip9Builder();
