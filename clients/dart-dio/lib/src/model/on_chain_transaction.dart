...
abstract class OnChainTransaction implements Built<OnChainTransaction, OnChainTransactionBuilder> {
    ...
    factory OnChainTransaction([void updates(OnChainTransactionBuilder b)]) = _$OnChainTransaction;

    @BuiltValueSerializer(custom: true)
    static Serializer<OnChainTransaction> get serializer => _$OnChainTransactionSerializer();
}

class _$OnChainTransactionSerializer implements StructuredSerializer<OnChainTransaction> {
    @override
    ...
    @override
    Iterable<Object?> serialize(Serializers serializers, OnChainTransaction object,
    ...
    @override
    OnChainTransaction deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
