    ...
    Payment deserialize(Serializers serializers, Iterable<Object?> serialized,
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                ...
                case r'status':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType.nullable(PaymentStatus)) as PaymentStatus?;
                ...
                case r'htlcs':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(BuiltList, [FullType(HTLCAttempt)])) as BuiltList<HTLCAttempt>;
                ...
                case r'failure_reason':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType.nullable(PaymentFailureReason)) as PaymentFailureReason?;
                    if (valueDes == null) continue;
