...
/// * [htlcMaximumMsat] 
/// * [extraOpaqueData] 
abstract class ChannelUpdate implements Built<ChannelUpdate, ChannelUpdateBuilder> {
    ...
    factory ChannelUpdate([void updates(ChannelUpdateBuilder b)]) = _$ChannelUpdate;

    @BuiltValueSerializer(custom: true)
    static Serializer<ChannelUpdate> get serializer => _$ChannelUpdateSerializer();
}
...
class _$ChannelUpdateSerializer implements StructuredSerializer<ChannelUpdate> {
    ...
    @override
    ChannelUpdate deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
