...
abstract class InvoiceHTLC implements Built<InvoiceHTLC, InvoiceHTLCBuilder> {
    ...
    static void _defaults(InvoiceHTLCBuilder b) => b
        ..customRecords = ListBuilder();
...
class _$InvoiceHTLCSerializer implements StructuredSerializer<InvoiceHTLC> {
    ...
    Iterable<Object?> serialize(Serializers serializers, InvoiceHTLC object,
        ...
        result
            ..add(r'state')
            ..add(object.state == null ? null : serializers.serialize(object.state,
        ...
        if (object.customRecords != null) {
            result
                ...
                ..add(serializers.serialize(object.customRecords,
                    specifiedType: const FullType(BuiltList, [FullType(CustomRecordsEntry)])));
        }
        result
        ...
        if (object.amp != null) {
            result
                ...
                ..add(serializers.serialize(object.amp,
                    specifiedType: const FullType(Amp)));
        }
        return result;
    }
    ...
    InvoiceHTLC deserialize(Serializers serializers, Iterable<Object?> serialized,
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                ...
                case r'state':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType.nullable(InvoiceHTLCState)) as InvoiceHTLCState?;
                    if (valueDes == null) continue;
                    result.state = valueDes;
                    break;
                case r'custom_records':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(BuiltList, [FullType(CustomRecordsEntry)])) as BuiltList<CustomRecordsEntry>;
                ...
                case r'amp':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(Amp)) as Amp;
