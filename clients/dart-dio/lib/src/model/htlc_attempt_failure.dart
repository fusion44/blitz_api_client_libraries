...
/// * [failureSourceIndex] 
/// * [height] 
abstract class HTLCAttemptFailure implements Built<HTLCAttemptFailure, HTLCAttemptFailureBuilder> {
    ...
    factory HTLCAttemptFailure([void updates(HTLCAttemptFailureBuilder b)]) = _$HTLCAttemptFailure;

    @BuiltValueSerializer(custom: true)
    static Serializer<HTLCAttemptFailure> get serializer => _$HTLCAttemptFailureSerializer();
}

class _$HTLCAttemptFailureSerializer implements StructuredSerializer<HTLCAttemptFailure> {
    @override
    ...
    @override
    Iterable<Object?> serialize(Serializers serializers, HTLCAttemptFailure object,
    ...
    @override
    HTLCAttemptFailure deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
