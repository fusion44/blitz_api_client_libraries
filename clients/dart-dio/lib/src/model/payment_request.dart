...
class _$PaymentRequestSerializer implements StructuredSerializer<PaymentRequest> {
    @override
        ...
        if (object.features != null) {
            result
                ...
                ..add(serializers.serialize(object.features,
                    specifiedType: const FullType(BuiltList, [FullType(FeaturesEntry)])));
        }
    ...
    @override
    PaymentRequest deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                ...
                case r'route_hints':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(BuiltList, [FullType(RouteHint)])) as BuiltList<RouteHint>;
                ...
                case r'features':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(BuiltList, [FullType(FeaturesEntry)])) as BuiltList<FeaturesEntry>;
