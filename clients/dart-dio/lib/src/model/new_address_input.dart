...
abstract class NewAddressInput implements Built<NewAddressInput, NewAddressInputBuilder> {
    ...
    factory NewAddressInput([void updates(NewAddressInputBuilder b)]) = _$NewAddressInput;

    @BuiltValueSerializer(custom: true)
    static Serializer<NewAddressInput> get serializer => _$NewAddressInputSerializer();
}

class _$NewAddressInputSerializer implements StructuredSerializer<NewAddressInput> {
    @override
    ...
    @override
    NewAddressInput deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
            ...
            switch (key) {
                case r'type':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType.nullable(OnchainAddressType)) as OnchainAddressType?;
