...
abstract class Bip9Statistics implements Built<Bip9Statistics, Bip9StatisticsBuilder> {
    ...
    factory Bip9Statistics([void updates(Bip9StatisticsBuilder b)]) = _$Bip9Statistics;

    @BuiltValueSerializer(custom: true)
    static Serializer<Bip9Statistics> get serializer => _$Bip9StatisticsSerializer();
}

class _$Bip9StatisticsSerializer implements StructuredSerializer<Bip9Statistics> {
    @override
    ...
    @override
    Bip9Statistics deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
