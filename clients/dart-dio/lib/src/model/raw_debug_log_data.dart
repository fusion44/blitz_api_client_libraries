...
abstract class RawDebugLogData implements Built<RawDebugLogData, RawDebugLogDataBuilder> {
    ...
    static void _defaults(RawDebugLogDataBuilder b) => b
        ..githubIssuesUrl = 'https://www.github.com/rootzoll/raspiblitz/issues';

    factory RawDebugLogData([void updates(RawDebugLogDataBuilder b)]) = _$RawDebugLogData;

    @BuiltValueSerializer(custom: true)
    static Serializer<RawDebugLogData> get serializer => _$RawDebugLogDataSerializer();
}

class _$RawDebugLogDataSerializer implements StructuredSerializer<RawDebugLogData> {
    @override
    ...
    @override
    RawDebugLogData deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
