...
abstract class LightningInfoLite implements Built<LightningInfoLite, LightningInfoLiteBuilder> {
    ...
    factory LightningInfoLite([void updates(LightningInfoLiteBuilder b)]) = _$LightningInfoLite;

    @BuiltValueSerializer(custom: true)
    static Serializer<LightningInfoLite> get serializer => _$LightningInfoLiteSerializer();
}

class _$LightningInfoLiteSerializer implements StructuredSerializer<LightningInfoLite> {
    @override
    ...
    @override
    LightningInfoLite deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
