...
/// Properties:
/// * [keepData] 
abstract class UninstallData implements Built<UninstallData, UninstallDataBuilder> {
    ...
    static void _defaults(UninstallDataBuilder b) => b
        ..keepData = true;

    factory UninstallData([void updates(UninstallDataBuilder b)]) = _$UninstallData;

    @BuiltValueSerializer(custom: true)
    static Serializer<UninstallData> get serializer => _$UninstallDataSerializer();
}
...
class _$UninstallDataSerializer implements StructuredSerializer<UninstallData> {
    ...
    @override
    UninstallData deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
