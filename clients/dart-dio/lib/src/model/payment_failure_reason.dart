...
class PaymentFailureReason extends EnumClass {
  ...
  static const PaymentFailureReason INCORRECT_PAYMENT_DETAILS = _$INCORRECT_PAYMENT_DETAILS;
  /// An enumeration.
  @BuiltValueEnumConst(wireName: r'FAILURE_REASON_INSUFFICIENT_BALANCE')
  static const PaymentFailureReason INSUFFICIENT_BALANCE = _$INSUFFICIENT_BALANCE;

  static Serializer<PaymentFailureReason> get serializer => _$paymentFailureReasonSerializer;
...
abstract class PaymentFailureReasonMixin = Object with _$PaymentFailureReasonMixin;
