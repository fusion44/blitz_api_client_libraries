...
abstract class SendCoinsResponse implements Built<SendCoinsResponse, SendCoinsResponseBuilder> {
    ...
    factory SendCoinsResponse([void updates(SendCoinsResponseBuilder b)]) = _$SendCoinsResponse;

    @BuiltValueSerializer(custom: true)
    static Serializer<SendCoinsResponse> get serializer => _$SendCoinsResponseSerializer();
}

class _$SendCoinsResponseSerializer implements StructuredSerializer<SendCoinsResponse> {
    @override
    ...
    @override
    SendCoinsResponse deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
