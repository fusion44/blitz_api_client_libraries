        ...
        if (object.localAddresses != null) {
            result
                ...
                ..add(serializers.serialize(object.localAddresses,
                    specifiedType: const FullType(BuiltList, [FullType(BtcLocalAddress)])));
        }
    ...
    NetworkInfo deserialize(Serializers serializers, Iterable<Object?> serialized,
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                ...
                case r'networks':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(BuiltList, [FullType(BtcNetwork)])) as BuiltList<BtcNetwork>;
                ...
                case r'local_addresses':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(BuiltList, [FullType(BtcLocalAddress)])) as BuiltList<BtcLocalAddress>;
