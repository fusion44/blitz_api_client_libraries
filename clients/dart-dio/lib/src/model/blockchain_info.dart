...
abstract class BlockchainInfo implements Built<BlockchainInfo, BlockchainInfoBuilder> {
    ...
    factory BlockchainInfo([void updates(BlockchainInfoBuilder b)]) = _$BlockchainInfo;

    @BuiltValueSerializer(custom: true)
    static Serializer<BlockchainInfo> get serializer => _$BlockchainInfoSerializer();
}

class _$BlockchainInfoSerializer implements StructuredSerializer<BlockchainInfo> {
    @override
    ...
    @override
    BlockchainInfo deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                ...
                case r'softforks':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(BuiltList, [FullType(SoftFork)])) as BuiltList<SoftFork>;
