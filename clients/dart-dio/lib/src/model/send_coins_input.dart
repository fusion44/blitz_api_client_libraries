...
/// * [amount] - The number of bitcoin denominated in satoshis to send
...
abstract class SendCoinsInput implements Built<SendCoinsInput, SendCoinsInputBuilder> {
    ...
    factory SendCoinsInput([void updates(SendCoinsInputBuilder b)]) = _$SendCoinsInput;

    @BuiltValueSerializer(custom: true)
    static Serializer<SendCoinsInput> get serializer => _$SendCoinsInputSerializer();
}

class _$SendCoinsInputSerializer implements StructuredSerializer<SendCoinsInput> {
    @override
    ...
    @override
    SendCoinsInput deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
