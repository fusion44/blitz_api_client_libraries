    ...
    Invoice deserialize(Serializers serializers, Iterable<Object?> serialized,
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                ...
                case r'state':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType.nullable(InvoiceState)) as InvoiceState?;
                    if (valueDes == null) continue;
                    result.state = valueDes;
                    break;
                case r'htlcs':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(BuiltList, [FullType(InvoiceHTLC)])) as BuiltList<InvoiceHTLC>;
