...
// Bip9Statistics struct for Bip9Statistics
...
func (o Bip9Statistics) MarshalJSON() ([]byte, error) {
...
type NullableBip9Statistics struct {
	value *Bip9Statistics
	isSet bool
}

func (v NullableBip9Statistics) Get() *Bip9Statistics {
	return v.value
}

func (v *NullableBip9Statistics) Set(val *Bip9Statistics) {
	v.value = val
	v.isSet = true
}

func (v NullableBip9Statistics) IsSet() bool {
	return v.isSet
}

func (v *NullableBip9Statistics) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBip9Statistics(val *Bip9Statistics) *NullableBip9Statistics {
	return &NullableBip9Statistics{value: val, isSet: true}
}

func (v NullableBip9Statistics) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBip9Statistics) UnmarshalJSON(src []byte) error {
	v.isSet = true
