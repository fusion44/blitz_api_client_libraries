...
// Bip9Data struct for Bip9Data
type Bip9Data struct {
...
func (o Bip9Data) MarshalJSON() ([]byte, error) {
...
type NullableBip9Data struct {
	value *Bip9Data
	isSet bool
}

func (v NullableBip9Data) Get() *Bip9Data {
	return v.value
}

func (v *NullableBip9Data) Set(val *Bip9Data) {
	v.value = val
	v.isSet = true
}

func (v NullableBip9Data) IsSet() bool {
	return v.isSet
}

func (v *NullableBip9Data) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBip9Data(val *Bip9Data) *NullableBip9Data {
	return &NullableBip9Data{value: val, isSet: true}
}

func (v NullableBip9Data) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBip9Data) UnmarshalJSON(src []byte) error {
	v.isSet = true
