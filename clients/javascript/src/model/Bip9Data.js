...
/**
 * The Bip9Data model module.
 * @module model/Bip9Data
 * @version 1
 */
class Bip9Data {
    /**
     * Constructs a new <code>Bip9Data</code>.
     * @alias module:model/Bip9Data
    ...
    /**
     * Constructs a <code>Bip9Data</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/Bip9Data} obj Optional instance to populate.
     * @return {module:model/Bip9Data} The populated <code>Bip9Data</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Bip9Data();
