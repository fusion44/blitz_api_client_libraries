...
(function(root, factory) {
  ...
  describe('LnInfo', function() {
    it('should create an instance of LnInfo', function() {
      // uncomment below and update the code to test LnInfo
      //var instance = new FastApi.LnInfo();
      //expect(instance).to.be.a(FastApi.LnInfo);
    });
    ...
    it('should have the property identityUri (base name: "identity_uri")', function() {
      // uncomment below and update the code to test the property identityUri
      //var instance = new FastApi.LnInfo();
      //expect(instance).to.be();
    });
