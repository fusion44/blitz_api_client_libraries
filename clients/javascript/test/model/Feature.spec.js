...
(function(root, factory) {
  ...
  describe('Feature', function() {
    it('should create an instance of Feature', function() {
      ...
      //var instance = new FastApi.Feature();
      //expect(instance).to.be.a(FastApi.Feature);
    });
    ...
    it('should have the property isKnown (base name: "is_known")', function() {
      // uncomment below and update the code to test the property isKnown
      //var instance = new FastApi.Feature();
      //expect(instance).to.be();
    });
