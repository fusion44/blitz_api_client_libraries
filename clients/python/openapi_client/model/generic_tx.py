...
class GenericTx(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, category, type, amount, time_stamp, status, *args, **kwargs):  # noqa: E501
        """GenericTx - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            index (int): The index of the transaction.. [optional] if omitted the server will use the default value of 0  # noqa: E501
            comment (str): Optional comment for this transaction. [optional] if omitted the server will use the default value of ""  # noqa: E501
            block_height (int): Block height, if included in a block. Only applicable for category **onchain**.. [optional]  # noqa: E501
            num_confs (int): Number of confirmations. Only applicable for category **onchain**.. [optional]  # noqa: E501
            total_fees (int): Total fees paid for this transaction. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, category, type, amount, time_stamp, status, *args, **kwargs):  # noqa: E501
        """GenericTx - a model defined in OpenAPI
