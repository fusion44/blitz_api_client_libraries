...
class Bip9Statistics(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, period, threshold, elapsed, count, possible, *args, **kwargs):  # noqa: E501
        """Bip9Statistics - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, period, threshold, elapsed, count, possible, *args, **kwargs):  # noqa: E501
        """Bip9Statistics - a model defined in OpenAPI
