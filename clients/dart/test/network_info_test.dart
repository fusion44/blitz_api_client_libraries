...
void main() {
  // final instance = NetworkInfo();

  group('test NetworkInfo', () {
    ...
    // List<String> localServicesNames (default value: const [])
    ...
    // List<BtcNetwork> networks (default value: const [])
    ...
    // List<BtcLocalAddress> localAddresses (default value: const [])
